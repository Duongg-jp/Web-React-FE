          ...
          <div className="d-flex">
            <div className="d-flex col-4 ">
              <ul className="d-flex m-auto">
                <li className="m-auto px-2 fs-6 font-playfair menu-nav">
                  <a href="">Nam</a>
                ...
                <li className="m-auto px-2 fs-6 font-playfair text-danger menu-nav">
                  <a href="">Sale</a>
                </li>
                <li className="m-auto px-2 fs-6 font-playfair menu-nav">
                  <a href="">Bộ sưu tập</a>
                  <ul className="sub-menu-nav">
                    <li className=" d-flex mt-3 ms-5">
                      <li>
                        ...
                        <li className="">
                          <a href="">OCEAN JEWELS</a>
                        </li>
                        <li className="">
                          <a href="">ARTISANAL DELICATE</a>
                        </li>
                        <li className="">
                          <a href="">THE FLOW</a>
                        </li>
